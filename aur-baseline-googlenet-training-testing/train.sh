...
echo '['$(date)']:' "GoogLeNet training complete."
...
echo '['$(date)']:' "Testing GoogLeNet..."
python test_model.py
echo '['$(date)']:' "GoogLeNet testing complete."

# Clean-up
echo '['$(date)']:' "Cleaning up..."
rm -rf /modelState/preprocessedData
#rm -rf /modelState/caffe_googlenet_iter_7.caffemodel
#rm -rf /modelState/caffe_googlenet_iter_7.solverstate
